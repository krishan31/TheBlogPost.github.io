                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php if ($posts['published']): ?>
                             <td><a href="edit.php?pusblished=0&p_id=<?php echo $posts['id'] ?>" class="unpublish">unpublish</a></td>
                        <?php else: ?>
                             <td><a href="edit.php?pusblished=1&p_id=<?php echo $posts['id'] ?>" class="publish">publish</a></td>
                        <?php endif; ?>
